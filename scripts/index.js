...
const initialCards = [
  ...
  {
    title: "Card Arches National Park",
  ...
  {
    title: "Card Grand Teton National Park",
...
profileEditModalForm.addEventListener('submit', profileFormSubmitHandler);
